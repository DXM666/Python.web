...
_reactDom2.default.render(_react2.default.createElement(_Todo2.default, null), document.getElementById('todo-container'));
...
var _TodoForm = __webpack_require__(35);

var _TodoForm2 = _interopRequireDefault(_TodoForm);

var _TodoTable = __webpack_require__(36);
...
var Todo = function (_Component) {
    ...
    _createClass(Todo, [{
        ...
        key: 'updateTodo',
        value: function updateTodo(id, status) {
            $.ajax({
                type: 'post',
                url: 'update',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_TodoTable2.default, { todos: this.state.todos, updateTodo: this.updateTodo, deleteTodo: this.deleteTodo })
            );
        }
    }]);
...
var TodoForm = function (_Component) {
    ...
    _createClass(TodoForm, [{
        ...
        value: function handleSubmit() {
            e.preventDefault();
            var content = _react2.default.findDOMNode(this.refs.content).value.trim();
            if (!content) {
                return;
            }
            this.props.addTodo(content);
            _react2.default.findDOMNode(this.refs.content).value = "";
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement("input", { ref: "content", className: "form-control", id: "content", name: "content", type: "text" }),
...
var _TodoItem = __webpack_require__(37);
...
var TodoTable = function (_Component) {
    _inherits(TodoTable, _Component);
    ...
    _createClass(TodoTable, [{
        ...
        value: function render() {
            var todos = this.props.todos.map(function (item) {
                return _react2.default.createElement(_TodoItem2.default, { key: item.id, todo: item, updateTodo: this.props.updateTodo, deleteTodo: this.props.deleteTodo });
            }.bind(this));
...
var TodoItem = function (_Component) {
    ...
    _createClass(TodoItem, [{
        key: "handleUpdate",
        value: function handleUpdate(id, status) {
        ...
        value: function render() {
            ...
            var updateBtn = void 0;

            if (t.status == 0) {
                updateBtn = _react2.default.createElement(
                    "button",
                    { onClick: this.handleUpdate.bind(this, t.id, 1), className: "btn btn-primary" },
                    "Done"
                );
            } else {
                updateBtn = _react2.default.createElement(
                    "button",
                    { onClick: this.handleUpdate.bind(this, t.id, 0), className: "btn btn-primary" },
                    "Undone"
                );
            }
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "button",
                        { onClick: this.handleDelete.bind(this, t.id), className: "btn btn-danger" },
                        "Delete"
                    )
                )
            );
